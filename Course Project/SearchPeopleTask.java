 ...
 */
public class SearchPeopleTask extends AsyncTask<String, Void, String> {
    ...
    final public static String TAG = "SearchPeopleTask";

    public SearchPeopleTask(Context context, Person a) {
    ...
    protected String doInBackground(String... params) {
        ...
        try
        {
            ...
            URL url = new URL("http://10.110.111.204/ems/index.php/application/get_json_person/" + url_params);
    ...
    protected void onPostExecute(String s) {
        ...
        p.setObject(s);
        /*
        Intent i = new Intent(context, List.class);
        i.putExtra("result", s);
